        ...
        <div className="container max-w-2xl lg:max-w-[1200px] mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              +19.500 blocos, hachuras, templates e bônus exclusivos. Sua Licença Vitalícia por <strong className="text-primary">R$ 37,00</strong>.
            </p>
            <motion.a
              href="https://pay.wiapy.com/5xnUmUDYB"
              className="btn-compra w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-gradient-gold text-primary-foreground font-display font-bold text-base sm:text-lg px-10 py-5 sm:py-4 rounded-xl shadow-gold animate-pulse-gold max-w-[320px] lg:max-w-none whitespace-nowrap mx-auto"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.96 }}
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
            >
              🚀 GARANTIR MINHA LICENÇA POR R$37,00
            </motion.a>
