...
const bonuses = [
  ...
  { num: "07", title: "Guia Autodesk Education", desc: "Passo a passo para obter o AutoCAD gratuitamente pelo programa oficial Autodesk Education.", oldPrice: "R$17", icon: BookOpen, img: "https://res.cloudinary.com/dxskz0q2z/image/upload/v1773348454/BONUS_07_wzadr0.jpg" },
      ...
      <div className="container max-w-7xl lg:max-w-[1200px] mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-3">
            Tudo que você recebe ao entrar na{" "}
            <span className="text-gradient-gold">Licença Vitalícia AutoCAD Pro</span>
          </h2>
