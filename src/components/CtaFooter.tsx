        ...
        <div className="container max-w-2xl lg:max-w-[1200px] mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <motion.a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-gradient-gold text-primary-foreground font-display font-bold text-base sm:text-lg px-10 py-5 sm:py-4 rounded-xl shadow-gold animate-pulse-gold max-w-[320px] lg:max-w-none whitespace-nowrap mx-auto"
