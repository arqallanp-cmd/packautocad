        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-6 max-w-lg lg:max-w-none mx-auto">
          ...
          <motion.div
            ...
            <motion.a
              ...
              className="block text-center bg-gradient-gold text-primary-foreground font-display font-bold py-3 text-lg sm:text-xl rounded-lg shadow-gold animate-pulse-gold w-full max-w-[320px] lg:max-w-none whitespace-nowrap mx-auto"
