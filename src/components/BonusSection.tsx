...
const bonuses = [
  ...
  { num: "09", title: "Certificado de Capacitação", subtitle: "20 horas · Válido para faculdade e estágio", desc: "Certificado digital de Capacitação Profissional em Produtividade com AutoCAD. Reconhecido para faculdade, portfolio e apresentação em processos seletivos e estágios.", oldPrice: "R$27", icon: GraduationCap, img: "https://res.cloudinary.com/dxskz0q2z/image/upload/f_auto,q_auto,w_400/BONUS_09_d4xgo7.jpg" },
  { num: "10", title: "Grupo VIP", subtitle: "Acesso vitalício · Comunidade fechada", desc: "Acesse hoje o grupo fechado de arquitetos, estudantes e profissionais do mercado. Tire dúvidas, troque projetos, receba indicações de clientes e fique por dentro das novidades do Pack em primeira mão.", oldPrice: "R$19", icon: Users, img: "https://res.cloudinary.com/dxskz0q2z/image/upload/v1773343468/BONUS_10_bt9fps.jpg", pills: ["💬 Suporte da comunidade", "🤝 Indicações de projetos", "🔔 Atualizações em primeira mão"] },
] as const;
