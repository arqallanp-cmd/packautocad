...
const bonuses = [
  ...
  { num: "10", title: "Grupo VIP", subtitle: "Acesso vitalício · Comunidade fechada", desc: "Acesse hoje o grupo fechado de arquitetos, estudantes e profissionais do mercado. Tire dúvidas, troque projetos, receba indicações de clientes e fique por dentro das novidades do Pack em primeira mão.", oldPrice: "R$19", icon: Users, img: bonus10Img, pills: ["💬 Suporte da comunidade", "🤝 Indicações de projetos", "🔔 Atualizações em primeira mão"] },
] as const;
